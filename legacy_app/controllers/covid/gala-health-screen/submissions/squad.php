...
<div class="container-xl">
  ...
  <div class="row">
    ...
    <div class="col-lg-8">
      ...
      <p>
        Need to quickly void all competition declarations for this squad? Press <strong>Void all</strong> to require all members to submit a new COVID-19 Return to Competition Declaration.
      </p>
