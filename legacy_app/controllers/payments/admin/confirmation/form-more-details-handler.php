...
$_SESSION['TENANT-' . tenant()->getLegacyTenant()->getId()]['PaymentConfSearch']['payment-amount'] = $_POST['payment-amount'];
$_SESSION['TENANT-' . tenant()->getLegacyTenant()->getId()]['PaymentConfSearch']['payment-name'] = $_POST['payment-name'];
