  ...
  <div class="row">
    ...
    <div class="col-6">
      <div class="mb-3">
        ...
        <input type="text" class="font-monospace form-control" id="payment-name" name="payment-name" aria-describedby="payment-name-help" placeholder="eg <?=htmlspecialchars($_SESSION['TENANT-' . tenant()->getLegacyTenant()->getId()]['Surname'])?>">
