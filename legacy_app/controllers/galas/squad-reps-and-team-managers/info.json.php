...
if (isset($_GET['squad'])) {
  ...
  if ($_SESSION['TENANT-' . tenant()->getLegacyTenant()->getId()]['AccessLevel'] != 'Parent' && $_GET['squad'] == 'all') {
    $squad = "all";
  } else {
