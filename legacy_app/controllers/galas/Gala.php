...
<div class="bg-light mt-n3 py-3 mb-3">
  <div class="container-xl">
    ...
    <div class="row align-items-center">
      ...
      <?php if ($_SESSION['TENANT-' . tenant()->getLegacyTenant()->getId()]['AccessLevel'] == "Galas" || $_SESSION['TENANT-' . tenant()->getLegacyTenant()->getId()]['AccessLevel'] == "Committee" || $_SESSION['TENANT-' . tenant()->getLegacyTenant()->getId()]['AccessLevel'] == "Admin" || $_SESSION['TENANT-' . tenant()->getLegacyTenant()->getId()]['AccessLevel'] == "Coach") { ?>
...
<div class="container-xl">
  ...
  <?php if (isset($_SESSION['TENANT-' . tenant()->getLegacyTenant()->getId()]['CreateRegisterSuccessStatus']) && $_SESSION['TENANT-' . tenant()->getLegacyTenant()->getId()]['CreateRegisterSuccessStatus']) { ?>
    <div class="alert alert-success">We've successfully created registers for this gala</div>
  <?php unset($_SESSION['TENANT-' . tenant()->getLegacyTenant()->getId()]['CreateRegisterSuccessStatus']);
  } ?>
  ...
  <div class="row">
    ...
    <?php if ($entry != null) { ?>
      ...
      <div class="col-sm-6 col-md-4">
        <h3 class="h6"><?php if ($_SESSION['TENANT-' . tenant()->getLegacyTenant()->getId()]['AccessLevel'] == 'Parent') { ?>Total cost of your entries<?php } else { ?>Total cost of entries<?php } ?></h3>
        <p>&pound;<?= number_format($total, 2) ?></p>
      </div>

      <?php if ($_SESSION['TENANT-' . tenant()->getLegacyTenant()->getId()]['AccessLevel'] != 'Parent' && $amountLeftToPay > 0) { ?>
        <div class="col-sm-6 col-md-4">
          <h3 class="h6">Total left to charge</h3>
          <p>&pound;<?= number_format($amountLeftToPay, 2) ?></p>
        </div>
      <?php } else if ($_SESSION['TENANT-' . tenant()->getLegacyTenant()->getId()]['AccessLevel'] != 'Parent' && $amountRefunded > 0) { ?>
        <div class="col-sm-6 col-md-4">
      ...
      <?php if ($_SESSION['TENANT-' . tenant()->getLegacyTenant()->getId()]['AccessLevel'] == 'Parent' && $amountRefunded > 0) { ?>
        <div class="col-sm-6 col-md-4">
      ...
      <div class="col-sm-6 col-md-4">
        <h3 class="h6"><?php if ($_SESSION['TENANT-' . tenant()->getLegacyTenant()->getId()]['AccessLevel'] == 'Parent') { ?>Total refunded to you<?php } else { ?>Total refunded to parents<?php } ?></h3>
  ...
  <?php if ($_SESSION['TENANT-' . tenant()->getLegacyTenant()->getId()]['AccessLevel'] == 'Parent' && $gala['CoachEnters']) { ?>
  ...
  <?php } else if ($_SESSION['TENANT-' . tenant()->getLegacyTenant()->getId()]['AccessLevel'] == 'Coach' || $_SESSION['TENANT-' . tenant()->getLegacyTenant()->getId()]['AccessLevel'] == 'Galas' || $_SESSION['TENANT-' . tenant()->getLegacyTenant()->getId()]['AccessLevel'] == 'Admin') { ?>
