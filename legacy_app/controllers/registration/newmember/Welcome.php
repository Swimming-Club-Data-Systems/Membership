...
if (!user_needs_registration($_SESSION['TENANT-' . tenant()->getLegacyTenant()->getId()]['UserID'])) {
  halt(404);
}
  ...
  <div class="row">
    <div class="col-lg-8">
      ...
      <ul>
        ...
        <li>Setup a Direct Debit for payments to <?=htmlspecialchars(config('CLUB_NAME'))?> and finally</li>
