...
if ($query->fetchColumn() != $_POST['email-addr']) {
  $_SESSION['TENANT-' . tenant()->getLegacyTenant()->getId()]['AC-UserDetails']['email-addr'] = $_POST['email-addr'];
  ...
  $mes = '<p>Hi ' . $_SESSION['TENANT-' . tenant()->getLegacyTenant()->getId()]['AC-UserDetails']['forename'] . ' ' . $_SESSION['TENANT-' . tenant()->getLegacyTenant()->getId()]['AC-UserDetails']['surname'] . '.</p>
  ...
  notifySend(null, $sub, $mes, $_SESSION['TENANT-' . tenant()->getLegacyTenant()->getId()]['AC-UserDetails']['forename'] . ' ' . $_SESSION['TENANT-' . tenant()->getLegacyTenant()->getId()]['AC-UserDetails']['surname'], $_POST['email-addr']);
  $_SESSION['TENANT-' . tenant()->getLegacyTenant()->getId()]['AC-Registration']['EmailModified'] = true;
