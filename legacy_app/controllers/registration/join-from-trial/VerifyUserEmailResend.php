...
if ($query->fetchColumn() != $_POST['email-addr']) {
  $code = $_SESSION['TENANT-' . tenant()->getLegacyTenant()->getId()]['AC-Registration']['EmailConfirmationCode'];
  ...
  $_SESSION['TENANT-' . tenant()->getLegacyTenant()->getId()]['AC-Registration']['EmailConfirmationResent'] = true;
