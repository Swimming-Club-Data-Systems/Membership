...
if ($query->fetchColumn() != $_POST['email-addr']) {
  $code = $_SESSION['TENANT-' . app()->tenant->getId()]['AC-Registration']['EmailConfirmationCode'];
  ...
  $_SESSION['TENANT-' . app()->tenant->getId()]['AC-Registration']['EmailConfirmationResent'] = true;
