...
$_SESSION['TENANT-' . tenant()->getLegacyTenant()->getId()]['AC-Registration']['Hash'] = $parent['Hash'];
$_SESSION['TENANT-' . tenant()->getLegacyTenant()->getId()]['AC-Registration']['Stage'] = 'UserDetails';
