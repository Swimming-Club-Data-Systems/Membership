...
$acc_details->execute([$_SESSION['TENANT-' . tenant()->getLegacyTenant()->getId()]['UserID']]);
...
fputcsv($output, array(config('CLUB_NAME') . ' User Data Download'));
...
fputcsv($output, array('First', 'Middle', 'Last', 'DOB', 'Squad', 'Sex', config('NGB_NAME') . ' ID', config('NGB_NAME') . ' Category (Internal ID)'));
