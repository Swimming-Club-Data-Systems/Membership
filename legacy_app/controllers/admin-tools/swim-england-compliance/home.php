    ...
    <div class="col-lg-8">
      ...
      <form method="post" class="needs-validation" novalidate>
        ...
        <div class="mb-3">
          ...
          <input type="url" class="form-control" id="web-address" name="web-address" value="<?= htmlspecialchars(tenant()->getLegacyTenant()->getWebsite()) ?>" readonly>
        </div>
        ...
        <div class="mb-3">
          ...
          <div class="input-group">
            ...
            <input type="url" class="form-control" id="facebook" name="facebook" value="<?= htmlspecialchars(config('FACEBOOK_PAGE')) ?>">
          </div>
        </div>
        ...
        <div class="mb-3">
          ...
          <div class="input-group">
            ...
            <input type="text" class="form-control" id="twitter" name="twitter" value="<?= htmlspecialchars(config('TWITTER_ACCOUNT')) ?>">
          </div>
        </div>
        ...
        <div class="mb-3">
          ...
          <textarea class="form-control" id="noticeboard" name="noticeboard"><?= htmlspecialchars(tenant()->getLegacyTenant()->getSwimEnglandComplianceValue('NOTICEBOARD_LOCATIONS')) ?></textarea>
        </div>
        ...
        <div class="mb-3">
          ...
          <textarea class="form-control" id="where-to-find-updates" name="where-to-find-updates"><?= htmlspecialchars(tenant()->getLegacyTenant()->getSwimEnglandComplianceValue('NEWS_LOCATIONS')) ?></textarea>
        </div>
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="welfare-name" name="welfare-name" value="<?= htmlspecialchars(tenant()->getLegacyTenant()->getSwimEnglandComplianceValue('WELFARE_NAME')) ?>" required>
        </div>
        ...
        <div class="mb-3">
          ...
          <input type="email" class="form-control" id="welfare-email" name="welfare-email" value="<?= htmlspecialchars(tenant()->getLegacyTenant()->getSwimEnglandComplianceValue('WELFARE_EMAIL')) ?>">
        </div>

        <div class="mb-3">
          <label for="welfare-phone" class="form-label">Welfare Officer Phone</label>
          <input type="tel" class="form-control" id="welfare-phone" name="welfare-phone" value="<?= htmlspecialchars(tenant()->getLegacyTenant()->getSwimEnglandComplianceValue('WELFARE_PHONE')) ?>">
        </div>
        ...
        <div class="mb-3">
          ...
          <textarea class="form-control" id="complaints-process" name="complaints-process"><?= htmlspecialchars(tenant()->getLegacyTenant()->getSwimEnglandComplianceValue('COMPLAINTS_PROCESS')) ?></textarea>
        </div>

        <div class="mb-3">
          <label for="complaints-name" class="form-label">Officer responsible for complaints name</label>
          <input type="text" class="form-control" id="complaints-name" name="complaints-name" value="<?= htmlspecialchars(tenant()->getLegacyTenant()->getSwimEnglandComplianceValue('COMPLAINTS_OFFICER')) ?>">
        </div>
        ...
        <div class="mb-3">
          ...
          <input type="email" class="form-control" id="complaints-email" name="complaints-email" value="<?= htmlspecialchars(tenant()->getLegacyTenant()->getSwimEnglandComplianceValue('COMPLAINTS_EMAIL')) ?>">
        </div>

        <div class="mb-3">
          <label for="complaints-phone" class="form-label">Officer responsible for complaints phone</label>
          <input type="tel" class="form-control" id="complaints-phone" name="complaints-phone" value="<?= htmlspecialchars(tenant()->getLegacyTenant()->getSwimEnglandComplianceValue('COMPLAINTS_PHONE')) ?>">
        </div>
        ...
        <div class="mb-3">
          ...
          <textarea class="form-control" id="facility-info" name="facility-info"><?= htmlspecialchars(tenant()->getLegacyTenant()->getSwimEnglandComplianceValue('FACILITY_INFORMATION')) ?></textarea>
        </div>

        <h2>SwimMark Status</h2>

        <?php ($status = tenant()->getLegacyTenant()->getSwimEnglandComplianceValue('SWIMMARK_STATUS')); ?>
        ...
        <div class="mb-3">
          ...
          <input type="date" class="form-control" id="swimmark-start" name="swimmark-start" value="<?= htmlspecialchars(tenant()->getLegacyTenant()->getSwimEnglandComplianceValue('SWIMMARK_START')) ?>">
        </div>

        <div class="mb-3">
          <label for="swimmark-end" class="form-label">Accreditation end date</label>
          <input type="date" class="form-control" id="swimmark-end" name="swimmark-end" value="<?= htmlspecialchars(tenant()->getLegacyTenant()->getSwimEnglandComplianceValue('SWIMMARK_END')) ?>">
        </div>
        ...
        <div class="mb-3">
          ...
          <textarea class="form-control" id="volunteering-opportunities" name="volunteering-opportunities"><?= htmlspecialchars(tenant()->getLegacyTenant()->getSwimEnglandComplianceValue('VOLUNTEERING_INFORMATION')) ?></textarea>
        </div>

        <h2>Youth engagement</h2>

        <div class="mb-3">
          <label for="youth-engagement" class="form-label">Explain how members under the age of 18 can contribute to <?= htmlspecialchars(tenant()->getLegacyTenant()->getName()) ?>. For example youth forums or groups.</label>
          <textarea class="form-control" id="youth-engagement" name="youth-engagement"><?= htmlspecialchars(tenant()->getLegacyTenant()->getSwimEnglandComplianceValue('YOUTH_ENGAGEMENT_INFORMATION')) ?></textarea>
        </div>
