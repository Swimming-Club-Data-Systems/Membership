...
<head>
  ...
  <?php } ?>
  <meta name="description" content="Your <?= htmlspecialchars(config('CLUB_NAME')) ?> Account lets you make gala entries online and gives you access to all your information about your swimmers, including attendance.">
