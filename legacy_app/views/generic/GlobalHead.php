...
<head>
  ...
  <?php if (isset($pagetitle) && ($pagetitle != "" || $pagetitle != null)) { ?>
    <title><?= $pagetitle ?> - <?= htmlspecialchars(config('CLUB_NAME')) ?> Membership</title>
  <?php } else { ?>
    <title><?= htmlspecialchars(config('CLUB_NAME')) ?> Membership</title>
  <?php } ?>
  <meta name="description" content="Your <?= config('CLUB_NAME') ?> Account lets you make gala entries online and gives you access to all your information about your swimmers, including attendance.">
  <meta name="viewport" content="width=device-width, initial-scale=1.0,
    user-scalable=no,maximum-scale=1">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta name="apple-mobile-web-app-title" content="<?= htmlspecialchars(config('CLUB_SHORT_NAME')) ?> Accounts">
  <meta name="format-detection" content="telephone=no">
  <meta name="googlebot" content="noarchive, nosnippet">
  <meta name="X-CLSW-System" content="Membership">
  <meta name="og:type" content="website">
  <meta name="og:locale" content="en_GB">
  <meta name="og:site_name" content="<?= htmlspecialchars(config('CLUB_NAME')) ?> Account">
  ...
  <?php if (config('SYSTEM_COLOUR')) { ?>
    <meta name="theme-color" content="<?= htmlspecialchars(config('SYSTEM_COLOUR')) ?>" media="(prefers-color-scheme: light)">
  <?php } else { ?>
