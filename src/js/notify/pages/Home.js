...
const actions = [
  ...
  { title: "SMS lists", href: "/notify/sms", icon: DeviceMobileIcon, iconForeground: "text-yellow-700", iconBackground: "bg-yellow-50" },
  {
    title: "Reply-to settings",
    href: "/notify/reply-to",
    icon: CogIcon,
