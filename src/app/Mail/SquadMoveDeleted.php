...
class SquadMoveDeleted extends Mailable
{
    ...
    public function envelope(): Envelope
    {
        return new Envelope(
            ...
            subject: 'A squad move for '.$this->squadMove->member->name.' has been cancelled',
        );
    }
    ...
    {
        return new Content(
            markdown: 'emails.members.squad_move_deleted',
        );
    }
