  ...
  <div class="row">
    <div class="col-lg-8">
      ...
      <ul>
        ...
        <li>Setup a Direct Debit for payments to <?=htmlspecialchars(app()->tenant->getKey('CLUB_NAME'))?> and finally</li>
      ...
      <p class="mb-0">
        <a href="<?php echo autoUrl("renewal/go"); ?>" class="btn btn-primary">
          Start Registration
        </a>
      </p>
