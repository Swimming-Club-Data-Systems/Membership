                  ...
                  ?>
                    <li class="list-group-item">
                      <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                          <div class="btn-group">
                            <a href="<?= htmlspecialchars(autoUrl('covid/competition-health-screening/new-survey?member=' . $member['MemberID'] . '&gala=' . $gala['GalaID'])) ?>" class="btn btn-primary">View and sign form</a>
                          </div>
                        </div>
                      </div>
                    </li>
