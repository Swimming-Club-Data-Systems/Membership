...
return [
    ...
    'jobs' => [
        ...
        'payment_intent.canceled' => \App\Jobs\StripeWebhooks\HandlePaymentIntentCanceled::class,
        'payment_intent.created' => \App\Jobs\StripeWebhooks\HandlePaymentIntentCreated::class,
        'payment_intent.partially_funded' => \App\Jobs\StripeWebhooks\HandlePaymentIntentPartiallyFunded::class,
        'payment_intent.payment_failed' => \App\Jobs\StripeWebhooks\HandlePaymentIntentPaymentFailed::class,
        'payment_intent.processing' => \App\Jobs\StripeWebhooks\HandlePaymentIntentProcessing::class,
        'payment_intent.requires_action' => \App\Jobs\StripeWebhooks\HandlePaymentIntentRequiresAction::class,
