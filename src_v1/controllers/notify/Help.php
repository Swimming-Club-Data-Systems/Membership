...
<div class="container-xl">
	<div class="row">
		<div class="col-lg-8 mb-5">
			<h1>Notify from <?= htmlspecialchars((string) app()->tenant->getKey('CLUB_NAME')) ?></h1>
			<p class="lead">
			...
			<div class="alert alert-info">
				<p class="mb-0">
					<strong>Unwanted emails from <?= htmlspecialchars((string) app()->tenant->getKey('CLUB_NAME')) ?> or SCDS?</strong>
				</p>
				<p class="mb-0">
