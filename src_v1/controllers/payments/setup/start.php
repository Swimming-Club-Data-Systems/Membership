...
<div class="container-xl">
	...
	<div class="row">
		<div class="col-lg-8">
			<div class="mb-3">
				<h1>Setup a Direct Debit to pay <?=htmlspecialchars((string) app()->tenant->getKey('CLUB_NAME'))?></h1>
				<p class="lead">
		...
		<div class="col">
			...
			<p class="text-center">
				...
				autoUrl("img/directdebit/directdebit.png", false); ?>" srcset="<?php echo
				autoUrl("img/directdebit/directdebit@2x.png", false); ?> 2x, <?php echo
				autoUrl("img/directdebit/directdebit@3x.png", false); ?> 3x" alt="Direct
				Debit Logo">
			</p>
			<p>
			...
			<ul>
				...
				<li>
					...
					Direct Debit <?=htmlspecialchars((string) app()->tenant->getKey('CLUB_NAME'))?> will notify you three working
					days in advance of your account being debited or as otherwise
					agreed. If you request <?=htmlspecialchars((string) app()->tenant->getKey('CLUB_NAME'))?> to collect a payment,
				...
				<li>
					...
					<?=htmlspecialchars((string) app()->tenant->getKey('CLUB_NAME'))?> or your bank or building society, you are
					...
					<ul>
						<li>
							...
							back when <?=htmlspecialchars((string) app()->tenant->getKey('CLUB_NAME'))?> asks you to
						</li>
					</ul>
				</li>
				<li>
			...
			<?=htmlspecialchars((string) app()->tenant->getKey('CLUB_NAME'))?>.</p>
		</div>
	</div>
	</div>
</div>
