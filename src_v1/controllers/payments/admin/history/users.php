...
$pagetitle = htmlspecialchars((string) $name) . "'s Transaction History";
...
<div class="container-xl">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page"><?=htmlspecialchars((string) $name)?></li>
    </ol>
  </nav>
	<div class="">
		<h1 class="border-bottom border-gray pb-2 mb-2">
			Transaction History for <?=htmlspecialchars((string) $name)?>
		</h1>
