        ...
        <div class="container-xl">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?= autoUrl("galas/" . $id . "/team-manager") ?>">TM
                            Dashboard</a></li>
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="alert alert-danger">
                    <p class="mb-0">You <strong>must not disclose data about any swimmers on this page</strong> to other
                        people. If somebody needs access to this data, they will have been granted access to it via
                        their own account.</p>
                </div>
                        ...
                        do {
                            ...
                            <li class="list-group-item <?php if ($i % 2 == 1) { ?>bg-light<?php } ?>">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col text-md-end">
                                        <button class="btn btn-primary" data-bs-toggle="collapse"
                                                data-bs-target="#swimmer-info-box-<?= $i ?>" role="button"
                                                aria-expanded="false" aria-controls="swimmer-info-box-<?= $i ?>">
                                ...
                                <div class="collapse" id="swimmer-info-box-<?= $i ?>"
                                     data-bs-parent="#swimmer-details-accordion">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md">
                                            ...
                                            if ($swimmer['UserID']) {
                                                ...
                                                <?php } ?>
                                            <?php } else { ?>
                                                <p>There is no user for this member</p>
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
