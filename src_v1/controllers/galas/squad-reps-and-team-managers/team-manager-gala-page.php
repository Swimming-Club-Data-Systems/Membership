...
$pagetitle = htmlspecialchars((string) $gala['GalaName']) . " - Team Managers";
...
<div class="front-page mb-n3">
  <div class="container-xl">
    ...
    <div class="row">
      <div class="col-md-8">
        <h1><?=htmlspecialchars((string) $gala['GalaName'])?><br><small>Team Managers</small></h1>
        <p class="lead">Welcome to the team manager dashboard for <?=htmlspecialchars((string) $gala['GalaName'])?>.</p>
