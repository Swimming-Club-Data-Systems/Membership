...
$pagetitle = htmlspecialchars((string) $squad['SquadName']) . ' - COVID Risk Awareness';
  ...
  <div class="container-xl">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?= htmlspecialchars((string) autoUrl('covid/risk-awareness#squads')) ?>">Squads</a></li>
    ...
    <div class="row align-items-center">
      <div class="col-lg-8">
        <h1>
          <?= htmlspecialchars((string) $squad['SquadName']) ?> Risk Awareness Forms
        </h1>
        <p class="lead mb-0">
