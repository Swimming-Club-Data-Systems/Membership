...
try {
  ...
  if (isset($_POST['submission'])) {
    ...
    if ($memberUser) {
      ...
      $message .= '</ul><p>As a result, we will need you to <a href="' . htmlspecialchars((string) autoUrl('covid/health-screening')) . '" target="_blank">complete a new COVID-19 Health Survey</a> before we can let you back into our training sessions.</p>';
