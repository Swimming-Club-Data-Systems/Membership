        ...
        <div class="row">
          <div class="col-md-10 col-lg-8">
            ...
            <div class="row">
              ...
              <div class="col">
                ...
                <div class="mb-3">
                  ...
                  value="<?php if (isset($_SESSION['TENANT-' . app()->tenant->getId()]['RegistrationForename'])) { ?><?=htmlspecialchars((string) $_SESSION['TENANT-' . app()->tenant->getId()]['RegistrationForename'])?><?php } ?>" autocomplete="given-name">
              ...
              <div class="col">
                ...
                <div class="mb-3">
                  ...
                  value="<?php if (isset($_SESSION['TENANT-' . app()->tenant->getId()]['RegistrationSurname'])) { ?><?=htmlspecialchars((string) $_SESSION['TENANT-' . app()->tenant->getId()]['RegistrationSurname'])?><?php } ?>" autocomplete="family-name">
                  <div class="invalid-feedback">
            ...
            <div class="mb-3">
              ...
              <input class="form-control mb-0 text-lowercase" type="email" name="email" id="email-address" placeholder="yourname@example.com" required value="<?php if (isset($_SESSION['TENANT-' . app()->tenant->getId()]['RegistrationEmail'])) { ?><?=htmlspecialchars((string) $_SESSION['TENANT-' . app()->tenant->getId()]['RegistrationEmail'])?><?php } ?>" autocomplete="email">
              <small id="emailHelp" class="form-text text-muted">
                Your email address will only be used inside <?=htmlspecialchars((string) app()->tenant->getKey('CLUB_NAME'))?> and SCDS.
              </small>
              <div class="invalid-feedback">
        ...
        <div class="row">
          <div class="col-md-10 col-lg-8">
            <div class="mb-3">
              ...
              <input class="form-control" type="tel" pattern="\+{0,1}[0-9]*" name="mobile" id="mobile" placeholder="01234 567890" required value="<?php if (isset($_SESSION['TENANT-' . app()->tenant->getId()]['RegistrationMobile'])) { ?><?=htmlspecialchars((string) $_SESSION['TENANT-' . app()->tenant->getId()]['RegistrationMobile'])?><?php } ?>" autocomplete="tel">
