    ...
    <div class="row justify-content-center py-5">
      <div class="col-lg-8 col-md-10">
        ...
        <?php if (isset($addr->streetAndNumber)) { ?>
          ...
          <address>
            <?= htmlspecialchars((string) $addr->streetAndNumber) ?><br>
            <?php if (isset($addr->flatOrBuilding)) { ?>
              <?= htmlspecialchars((string) $addr->flatOrBuilding) ?><br>
            <?php } ?>
            <?= htmlspecialchars(mb_strtoupper((string) $addr->city)) ?><br>
            <?= htmlspecialchars(mb_strtoupper((string) $addr->postCode)) ?><br>
          </address>
        ...
        <form method="post" class="needs-validation" novalidate>
          <div class="mb-3">
            ...
            <input class="form-control" name="street-and-number" id="street-and-number" type="text" autocomplete="address-line1" <?php if (isset($addr->streetAndNumber)) { ?>value="<?= htmlspecialchars((string) $addr->streetAndNumber) ?>" <?php } ?> required>
          ...
          <div class="mb-3">
            ...
            <input class="form-control" name="flat-building" id="flat-building" type="text" autocomplete="address-line2" <?php if (isset($addr->flatOrBuilding)) { ?>value="<?= htmlspecialchars((string) $addr->flatOrBuilding) ?>" <?php } ?>>
          </div>

          <div class="mb-3">
            <label class="form-label" for="town-city">Town/City</label>
            <input class="form-control" name="town-city" id="town-city" type="text" autocomplete="address-level2" <?php if (isset($addr->city)) { ?>value="<?= htmlspecialchars((string) $addr->city) ?>" <?php } ?> required>
            <div class="invalid-feedback">
          ...
          <div class="mb-3">
            ...
            <input class="form-control" name="county-province" id="county-province" type="text" autocomplete="address-level1" <?php if (isset($addr->county)) { ?>value="<?= htmlspecialchars((string) $addr->county) ?>" <?php } ?> required>
            <div class="invalid-feedback">
          ...
          <div class="mb-3">
            ...
            <input class="form-control" name="post-code" id="post-code" type="text" autocomplete="postal-code" <?php if (isset($addr->postCode)) { ?>value="<?= htmlspecialchars((string) $addr->postCode) ?>" <?php } ?> required>
            <div class="invalid-feedback">
