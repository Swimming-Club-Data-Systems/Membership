...
class Assets {
  ...
  public static function cardLogos() {
    ...
    $html .= '<img class="visa-row" src="' . htmlspecialchars(autoUrl("img/stripe/brand-checkout/visa_light.svg")) . '" aria-hidden="true">';
    ...
    $html .= '<img class="mastercard-row" src="' . htmlspecialchars(autoUrl("img/stripe/brand-checkout/maestro_light.svg")) . '" aria-hidden="true">';
