                ...
                <?php if (!empty($_SESSION['TENANT-' . app()->tenant->getId()]['LoggedIn'])) { ?>
                    ...
                    <?php if ($_SESSION['TENANT-' . app()->tenant->getId()]['AccessLevel'] == "Parent") { ?>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="swimmersDropdown">
                                <a class="dropdown-item" href="<?= htmlspecialchars(autoUrl("members")) ?>">Members
                                    Home</a>
                                <a class="dropdown-item" href="<?= htmlspecialchars(autoUrl("memberships")) ?>">Membership
                                    Centre</a>
                                ...
                                <?php } else { ?>
                                    <a class="dropdown-item" href="<?= autoUrl("my-account/add-member") ?>">Link a new
                                        member</a>
                                <?php } ?>
                            </div>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="swimmerDropdown">
                                ...
                                <?php if ($_SESSION['TENANT-' . app()->tenant->getId()]['AccessLevel'] == "Admin") { ?>
                                    ...
                                    <a class="dropdown-item" href="<?= autoUrl("memberships/renewal") ?>">Membership
                                        Renewal</a>
                                    <a class="dropdown-item" href="<?= autoUrl("members/orphaned") ?>"
                                       title="View active members who are not connected to a user account">Unconnected
                                        Members</a>
                                    <?php if (app()->user->hasPermission('Admin')) { ?>
                                        <a class="dropdown-item"
                                           href="<?= htmlspecialchars(autoUrl("qualifications")) ?>">Qualifications</a>
                                    <?php } ?>
                                <?php } ?>
                                <?php if ($_SESSION['TENANT-' . app()->tenant->getId()]['AccessLevel'] != "Galas") { ?>
                                    <a class="dropdown-item" href="<?= autoUrl("members/access-keys") ?>">Access
                                        Keys</a>
                                <?php } ?>
                                <a class="dropdown-item" href="<?= htmlspecialchars(autoUrl("memberships")) ?>">Membership
                                    Centre</a>
                                ...
                                <a class="dropdown-item" href="<?= htmlspecialchars(autoUrl("log-books")) ?>">Log
                                    Books</a>
                            </div>
                        </li>
                    <?php } ?>
                    ...
                    <?php if ($user->hasPermissions(['Admin', 'Coach', 'Committee'])) { ?>
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="registerDropdown">
                                <a class="dropdown-item" href="<?= htmlspecialchars(autoUrl("attendance")) ?>">Attendance
                                    Home</a>
                                <a class="dropdown-item" href="<?= htmlspecialchars(autoUrl("attendance/register")) ?>">Take
                                    Register</a>
                                <a class="dropdown-item"
                                   href="<?= htmlspecialchars(autoUrl('timetable')) ?>">Timetable</a>
                                <a class="dropdown-item" href="<?= htmlspecialchars(autoUrl('timetable/booking')) ?>">Bookings</a>
                                <a class="dropdown-item" href="<?= htmlspecialchars(autoUrl("attendance/sessions")) ?>">Manage
                                    Squad Sessions</a>
                                <?php if ($user->hasPermissions(['Admin', 'Committee'])) { ?>
                                    <a class="dropdown-item"
                                       href="<?= htmlspecialchars(autoUrl("attendance/venues")) ?>">Manage Venues</a>
                                <?php } ?>
                                <a class="dropdown-item" href="<?= htmlspecialchars(autoUrl("attendance/history")) ?>">Attendance
                                    History</a>
                            </div>
                        </li>
                    <?php } ?>
                    ...
                    <?php if ($_SESSION['TENANT-' . app()->tenant->getId()]['AccessLevel'] != "Parent") { ?>
                        <?php if (
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" id="usersMenu" role="button"
                                   data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    Users
                                </a>
                        ...
                        <?php if ($_SESSION['TENANT-' . app()->tenant->getId()]['AccessLevel'] == "Admin") { ?>
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="paymentsAdminDropdown">
                                    ...
                                    <a class="dropdown-item" href="<?= autoUrl("payments/history") ?>">Payment
                                        Status</a>
                                    ...
                                    <a class="dropdown-item"
                                       href="<?= htmlspecialchars(autoUrl("payments/history/squads/" . $date->format("Y/m"))) ?>">
                                        Squad Fees
                                    </a>
                                    <a class="dropdown-item"
                                       href="<?= htmlspecialchars(autoUrl("payments/history/extras/" . $date->format("Y/m"))) ?>">
                                        Extra Fees
                                    </a>
                                    <div class="dropdown-divider"></div>
                        ...
                        <?php if ($_SESSION['TENANT-' . app()->tenant->getId()]['AccessLevel'] == "Admin" || $_SESSION['TENANT-' . app()->tenant->getId()]['AccessLevel'] == "Coach" || $_SESSION['TENANT-' . app()->tenant->getId()]['AccessLevel'] == "Galas") { ?>
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="notifyDropdown">
                                    ...
                                    <?php } ?>
                                    <a class="dropdown-item" href="<?= autoUrl("notify/history") ?>">Previous
                                        Messages</a>
                                </div>
                            </li>
                        <?php } ?>
                    <?php } ?>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="galaDropdown" role="button"
                           data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Galas
                        </a>
                        <div class="dropdown-menu" aria-labelledby="galaDropdown">
                            ...
                            <?php if (app()->tenant->isCLS()) { ?>
                                ...
                                <a class="dropdown-item"
                                   href="https://www.chesterlestreetasc.co.uk/competitions/category/galas/"
                    ...
                    <?php if ($_SESSION['TENANT-' . app()->tenant->getId()]['AccessLevel'] == "Parent" && app()->tenant->getKey('ASA_CLUB_CODE') != 'UOSZ') {
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="paymentsParentDropdown">
                                ...
                                <a class="dropdown-item" href="<?= autoUrl("payments") ?>">Payments Home</a>
                                <a class="dropdown-item" href="<?= autoUrl("payments/statements") ?>">My Billing
                                    History</a>
                                <?php if (app()->tenant->getGoCardlessAccessToken() && $hasMandate && !stripeDirectDebit(true)) { ?>
                                    <a class="dropdown-item" href="<?= autoUrl("payments/mandates") ?>">My Bank Account
                                        (Old System)</a>
                                ...
                                <?php if (stripeDirectDebit() && $hasStripeMandate) { ?>
                                    <a class="dropdown-item" href="<?= autoUrl("payments/direct-debit") ?>">My Bank
                                        Account (New System)</a>
                                ...
                                <?php } ?>
                                <a class="dropdown-item" href="<?= autoUrl("payments/statements/latest") ?>">My Latest
                                    Statement</a>
                                <a class="dropdown-item" href="<?= autoUrl("payments/fees") ?>">My Fees Since Last
                                    Bill</a>
                                <div class="dropdown-divider"></div>
                    ...
                    <?php if (isset(app()->user) && app()->user->hasPermission('Admin')) { ?>
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="postDropdown">
                                ...
                                <a class="dropdown-item" href="<?= htmlspecialchars(autoUrl('pages/new')) ?>">New
                                    Page</a>
                            </div>
                        </li>
                        <?php if ($_SESSION['TENANT-' . app()->tenant->getId()]['AccessLevel'] == 'Admin') { ?>
