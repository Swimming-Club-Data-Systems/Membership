                ...
                <li class="list-group-item">
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <ul class="mb-0 list-unstyled">
                                <?php if ($squad = $getSquads->fetch(PDO::FETCH_ASSOC)) {
                                    do { ?>
                                        <li><?= htmlspecialchars($squad['squad']) ?>,
                                            <em><?php if (!bool($squad['Paying']) || (int)$squad['fee'] == 0) { ?>
                                                    <del>
                                                    &pound;<?= (string)(\Brick\Math\BigDecimal::of((string)$squad['fee']))->toScale(2) ?></del> &pound;0/month<?php } else { ?>&pound;<?= (string)(\Brick\Math\BigDecimal::of((string)$squad['fee']))->toScale(2) ?>/month<?php } ?>
                                            </em></li>
                        ...
                        <div class="col text-sm-end">
                            <p class="mb-0">
                                <a href="https://www.swimmingresults.org/biogs/biogs_details.php?tiref=<?= htmlspecialchars($swimmer['ASANumber']) ?>"
                                   target="_blank"
                                   title="Swim England Biographical Data"><?= htmlspecialchars($swimmer['ASANumber']) ?>
        ...
        <div class="list-group">
            <?php do { ?>
                <a class="list-group-item list-group-item-action"
                   href="<?= htmlspecialchars((autoUrl("payments/statements/" . $row['PaymentID']))) ?>"
