    ...
    <>
      ...
      <div className="bg-gray-100 dark:bg-slate-900 dark:text-gray-100">
        <div className="container mx-auto py-3 min-h-screen">
          <div className="mb-3">
            <ApplicationLogo />
            <h1 className="mt-2 text-indigo-600 dark:text-indigo-400 font-bold text-3xl">Form Components</h1>
            <p className="font-bold text-2xl">Formik Children Styled Up</p>
          </div>
